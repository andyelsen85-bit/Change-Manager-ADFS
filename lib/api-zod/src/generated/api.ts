...
export const LoginResponse = zod.object({
  ...
  "isAdmin": zod.boolean(),
  "mustChangePassword": zod.boolean().describe('True when the user must rotate their password before using the rest of the app (e.g. seeded admin on first login).')
})
...
export const ListUsersQueryParams = zod.object({
  ...
  "primary": zod.enum(['1', 'true']).optional().describe('When combined with `role`, restrict to non-deputy assignments.')
})
...
export const GetNotificationPreferencesResponse = zod.array(GetNotificationPreferencesResponseItem)
...
export const UpdateNotificationPreferencesBody = zod.array(UpdateNotificationPreferencesBodyItem)
...
export const UpdateNotificationPreferencesResponse = zod.array(UpdateNotificationPreferencesResponseItem)
...
export const ListRoleAssignmentsResponseItem = zod.object({
  ...
  "primaryAssignmentId": zod.int().nullish()
})
...
export const GetChangeResponse = zod.object({
  "id": zod.int(),
  "ref": zod.string(),
  "title": zod.string(),
  "description": zod.string(),
...
export const DeleteChangeResponse = zod.void()
...
export const RevertChangeBody = zod.object({
  ...
  "reason": zod.string().min(revertChangeBodyReasonMin).describe('Required justification, captured in the audit log.')
})
...
export const CreateCabMeetingBody = zod.object({
  ...
  "location": zod.string(),
  "agenda": zod.string(),
  "timeZone": zod.string().optional().describe('Creator\'s IANA timezone; recurring occurrences keep the same wall-clock time in this zone across DST changes.'),
  "recurring": zod.boolean().optional(),
  "recurrenceIntervalWeeks": zod.int().optional(),
  "recurrenceUntil": zod.coerce.date().optional(),
  "memberUserIds": zod.array(zod.int()),
  "changeIds": zod.array(zod.int())
})

export const CreateCabMeetingResponse = zod.object({
  "id": zod.int(),
  "title": zod.string(),
  "kind": zod.enum(['cab', 'ecab']),
  "scheduledStart": zod.coerce.date(),
...
export const GetCabMeetingResponse = zod.object({
  "id": zod.int(),
  "title": zod.string(),
  "kind": zod.enum(['cab', 'ecab']),
  "scheduledStart": zod.coerce.date(),
...
export const UpdateCabMeetingBody = zod.object({
  ...
  "memberUserIds": zod.array(zod.int()).optional(),
  "changeIds": zod.array(zod.int()).optional(),
  "minutes": zod.string().optional()
})
...
export const DeleteCabMeetingResponse = zod.void()
...
export const GetCabMeetingIcsResponse = zod.unknown()
...
export const SendCabAgendaResponse = zod.object({
  "sent": zod.int().describe('Members who received the agenda email.'),
  "skipped": zod.int().describe('Members whose notification preference opted out, or for whom no SMTP was configured.'),
  "errors": zod.int().describe('Members for whom the SMTP send failed.')
})
...
export const GetDashboardSummaryResponse = zod.object({
  "totalChanges": zod.int(),
  "openChanges": zod.int(),
  "awaitingApproval": zod.int(),
  "scheduledThisWeek": zod.int(),
  "emergencyOpen": zod.int(),
...
export const TestLdapResponse = zod.object({
  "success": zod.boolean().describe('True if the user-bind succeeded end-to-end.'),
  "stage": zod.enum(['config', 'connect', 'service-bind', 'search', 'user-bind', 'ok']).describe('Phase the bind reached. On failure this is the phase that broke.'),
  "message": zod.string().describe('Human-readable summary suitable for showing to the admin.'),
  "code": zod.string().optional().describe('LDAP result-code name (e.g. InvalidCredentialsError) or socket error code (e.g. ECONNREFUSED). Optional.'),
  "details": zod.string().optional().describe('Server-side diagnostic message from the directory, when one was returned. Optional.'),
  "userDn": zod.string().optional().describe('The full DN that was resolved and bound. Populated only on success.')
})
...
export const TestAdfsSettingsResponse = zod.object({
  "success": zod.boolean(),
  "message": zod.string(),
  "issuer": zod.string().optional(),
  "authorizationEndpoint": zod.string().optional(),
  "tokenEndpoint": zod.string().optional()
})
